package Section18_FewNutsAndBolts.BigDecimal;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("totalUsing: %,.2f%n", totalUsingFloat);

        double total = policyAmount - ((policyAmount * percentage) * beneficiaries);
        System.out.printf("totalUsing: %,.2f%n", total);
        ...
        for (var bd : bds) {
            System.out.printf("%-15s %-15d %-8s %d %n", bd, bd.unscaledValue(), bd.scale(), bd.precision());
        }
