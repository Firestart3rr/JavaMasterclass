package Section18_FewNutsAndBolts.DateTimeLocalizationProject;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Jane in daylight savings? " +
                joesRules.isDaylightSavings(janeNow.toInstant()) + " " +
                joesRules.getDaylightSavings(janeNow.toInstant()) + ": " +
                joeNow.format(ofPattern("zzzz z")));
