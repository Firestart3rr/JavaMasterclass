...
public final class Pirate extends Combatant {
    ...
    private final List<Town> townVisited = new LinkedList<Town>();
    ...
    public String information() {
        ...
        var current = ((LinkedList<Town>) townVisited).getLast();
        String[] simpleNames = new String[townVisited.size()];
        Arrays.setAll(simpleNames, i -> townVisited.get(i).name());
        return "---> " + current +
