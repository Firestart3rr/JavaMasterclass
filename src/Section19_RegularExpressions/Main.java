package Section19_RegularExpressions;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Using string's fromatted method: " + helloWorld);
        ...
        String testString = "Anyone can Learn abd's, 123's, and any regular expression";
        String replacement = "(-)";
