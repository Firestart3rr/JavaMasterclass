package Section15_JavaCollections.SetOperationsChallenge;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Comparator<Task> priorityNatual = sortByPriority.thenComparing(
                Comparator.naturalOrder());
        sortAndPrint("Overlapping", overlapping, priorityNatual);
    }
